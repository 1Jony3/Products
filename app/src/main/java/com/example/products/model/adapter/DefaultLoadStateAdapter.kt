...
import com.example.products.databinding.ItemProductLoadStateFooterBinding
...
class DefaultLoadStateAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, loadState: LoadState): Holder {
        ...
        val binding = ItemProductLoadStateFooterBinding.inflate(inflater, parent, false)
        return Holder(binding, null, tryAgainAction)
    }
    class Holder(
        private val binding: ItemProductLoadStateFooterBinding,
